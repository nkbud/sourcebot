...
<Note>Hit an issue? Please let us know on [GitHub discussions](https://github.com/your-sourcebot-org/sourcebot/discussions/categories/support) or by [emailing us](mailto:team@your-sourcebot-instance.com).</Note>
...
<Steps>
    ...
    <Step title="Create a config.json">
        ...
        This config creates a single GitHub connection named `starter-connection` that specifies [Sourcebot](https://github.com/your-sourcebot-org/sourcebot) as a repo to sync. [Learn more about the config file](/docs/connections/overview).
    </Step>
