...
{
    "type": "git",
    "url": "https://github.com/your-sourcebot-org/sourcebot"
}
```
...
[schemas/v3/genericGitHost.json](https://github.com/your-sourcebot-org/sourcebot/blob/main/schemas/v3/genericGitHost.json)
