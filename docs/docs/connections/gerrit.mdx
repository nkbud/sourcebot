...
<Note>Authenticating with Gerrit is currently not supported. If you need this capability, please raise a [feature request](https://github.com/your-sourcebot-org/sourcebot/discussions/categories/ideas).</Note>
...
[schemas/v3/gerrit.json](https://github.com/your-sourcebot-org/sourcebot/blob/main/schemas/v3/gerrit.json)
