...
<Accordion title="Can I disable the authentication system?">
    ...
    within your organization please [reach out](https://your-sourcebot-instance.com
</Accordion>
...
<Accordion title="I'm deploying Sourcebot behind an identity proxy, do I still need to create an account in Sourcebot?">
    ...
    and require support, please [reach out](https://your-sourcebot-instance.com
</Accordion>
...
Have a question that's not answered here? Submit it on our [GitHub discussions](https://github.com/your-sourcebot-org/sourcebot/discussions)
