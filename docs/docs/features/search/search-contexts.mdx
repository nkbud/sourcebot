...
<Accordion title="Repository URL details">
    ...
    - `github.com/your-sourcebot-org/sourcebot` ([link](https://github.com/your-sourcebot-org/sourcebot))
...
[schemas/v3/searchContext.json](https://github.com/your-sourcebot-org/sourcebot/blob/main/schemas/v3/searchContext.json)
