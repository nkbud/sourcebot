...
The AI Code Review Agent is [open source](https://github.com/your-sourcebot-org/sourcebot/tree/main/packages/web/src/features/agents/review-agent) and packaged in [Sourcebot](https://github.com/your-sourcebot-org/sourcebot). To get started using this agent, [deploy Sourcebot](/docs/deployment-guide)
...
<Steps>
    <Step title="Register a GitHub app">
        ...
        - Homepage URL: You can make this whatever you want (ex. https://your-sourcebot-instance.com
    ...
    <Step title="Configure the environment variables in Sourcebot">
        ...
        services:
            sourcebot:
                image: ghcr.io/your-sourcebot-org/sourcebot:latest
                pull_policy: always
