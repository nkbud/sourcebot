...
If your deployment is dependent on these features, please [reach out](https://github.com/your-sourcebot-org/sourcebot/discussions).
</Warning>
...
<Steps>
    ...
    <Step title="You're done!">
        Congrats, you've successfully migrated to v3! Please let us know what you think of the new features by reaching out on our [discord](https://discord.gg/6Fhp27x7Pb) or [GitHub discussion](https://github.com/your-sourcebot-org/sourcebot/discussions/categories/support)
    </Step>
</Steps>
...
Having troubles migrating from v2 to v3? Reach out to us on [discord](https://discord.gg/6Fhp27x7Pb) or [GitHub discussion](https://github.com/your-sourcebot-org/sourcebot/discussions/categories/support) and we'll try our best to help