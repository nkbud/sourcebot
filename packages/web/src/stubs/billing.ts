...
export const incrementOrgSeatCount = async (_orgId: number, _prisma: any): Promise<any> => {
    // No-op: billing functionality has been removed
    return;
}

export const decrementOrgSeatCount = async (_orgId: number, _prisma: any): Promise<any> => {
    // No-op: billing functionality has been removed
    return;
}

export const getSubscriptionForOrg = async (_orgId: number, _prisma: any): Promise<any> => {
