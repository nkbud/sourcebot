...
describe('getBrowseParamsFromPathParam', () => {
    describe('tree paths', () => {
        it('should parse tree path with trailing slash', () => {
            const result = getBrowseParamsFromPathParam('github.com/nkbud/zoekt@HEAD/-/tree/');
            expect(result).toEqual({
                repoName: 'github.com/nkbud/zoekt',
                revisionName: 'HEAD',
                path: '',
                pathType: 'tree',
            });
        ...
        it('should parse tree path with nested directory', () => {
            const result = getBrowseParamsFromPathParam('github.com/nkbud/zoekt@HEAD/-/tree/packages/web/src');
            expect(result).toEqual({
                repoName: 'github.com/nkbud/zoekt',
                revisionName: 'HEAD',
        ...
        it('should parse tree path without revision', () => {
            const result = getBrowseParamsFromPathParam('github.com/nkbud/zoekt/-/tree/docs');
            expect(result).toEqual({
                repoName: 'github.com/nkbud/zoekt',
    ...
    describe('blob paths', () => {
        ...
        it('should parse blob path with file', () => {
            const result = getBrowseParamsFromPathParam('github.com/nkbud/zoekt@HEAD/-/blob/README.md');
            expect(result).toEqual({
                repoName: 'github.com/nkbud/zoekt',
                revisionName: 'HEAD',
                path: 'README.md',
        ...
        it('should parse blob path with nested file', () => {
            const result = getBrowseParamsFromPathParam('github.com/nkbud/zoekt@HEAD/-/blob/packages/web/src/app/page.tsx');
            expect(result).toEqual({
                repoName: 'github.com/nkbud/zoekt',
                revisionName: 'HEAD',
        ...
        it('should parse blob path without revision', () => {
            const result = getBrowseParamsFromPathParam('github.com/nkbud/zoekt/-/blob/main.go');
            expect(result).toEqual({
                repoName: 'github.com/nkbud/zoekt',
                revisionName: undefined,
                path: 'main.go',
    ...
    describe('URL decoding', () => {
        it('should decode URL-encoded spaces in path', () => {
            const result = getBrowseParamsFromPathParam('github.com/nkbud/zoekt@HEAD/-/tree/folder%20with%20spaces');
            expect(result).toEqual({
                repoName: 'github.com/nkbud/zoekt',
                revisionName: 'HEAD',
        ...
        it('should decode URL-encoded special characters in path', () => {
            const result = getBrowseParamsFromPathParam('github.com/nkbud/zoekt@HEAD/-/blob/file%20with%20%26%20symbols.txt');
            expect(result).toEqual({
                repoName: 'github.com/nkbud/zoekt',
                revisionName: 'HEAD',
    ...
    describe('different revision formats', () => {
        it('should parse with branch name', () => {
            const result = getBrowseParamsFromPathParam('github.com/nkbud/zoekt@main/-/tree/');
            expect(result).toEqual({
                repoName: 'github.com/nkbud/zoekt',
                revisionName: 'main',
                path: '',
        ...
        it('should parse with commit hash', () => {
            const result = getBrowseParamsFromPathParam('github.com/nkbud/zoekt@a1b2c3d/-/tree/');
            expect(result).toEqual({
                repoName: 'github.com/nkbud/zoekt',
        ...
        it('should parse with tag', () => {
            const result = getBrowseParamsFromPathParam('github.com/nkbud/zoekt@v1.0.0/-/tree/');
            expect(result).toEqual({
                repoName: 'github.com/nkbud/zoekt',
                revisionName: 'v1.0.0',
                path: '',
    ...
    describe('edge cases', () => {
        ...
        it('should handle paths with @ symbols', () => {
            const result = getBrowseParamsFromPathParam('github.com/nkbud/zoekt@HEAD/-/blob/file@v1.0.0.txt');
            expect(result).toEqual({
                repoName: 'github.com/nkbud/zoekt',
                revisionName: 'HEAD',
    ...
    describe('error cases', () => {
        it('should throw error for blob path with trailing slash and no path', () => {
            expect(() => {
                getBrowseParamsFromPathParam('github.com/nkbud/zoekt@HEAD/-/blob/');
            }).toThrow();
        });
        ...
        it('should throw error for invalid pattern - missing /-/', () => {
            expect(() => {
                getBrowseParamsFromPathParam('github.com/nkbud/zoekt@HEAD/tree/');
            }).toThrow();
        });

        it('should throw error for invalid pattern - missing tree/blob', () => {
            expect(() => {
                getBrowseParamsFromPathParam('github.com/nkbud/zoekt@HEAD/-/invalid/');
            }).toThrow();
        });
