...
// @see : https://github.com/your-sourcebot-org/zoekt/blob/main/query/parse.go#L417
enum zoektPrefixes {
    archived = "archived:",
    branchShort = "b:",
    branch = "branch:",
...
const transformZoektQuery = async (query: string, orgId: number): Promise<string | ServiceError> => {
    ...
    for (const part of prevQueryParts) {
        ...
        if (part.match(/^-?(rev|revision):.+$/)) {
            ...
            // @see: https://github.com/your-sourcebot-org/zoekt/blob/main/eval.go#L560-L562
            if (revisionName === "*") {
                revisionName = "";
            }
...
const getFileWebUrl = (template: string, branch: string, fileName: string): string | undefined => {
    ...
    // {{URLJoinPath "https://github.com/your-sourcebot-org/sourcebot" "blob" .Version .Path}}
    ...
    withAuth((userId, _apiKeyHash) =>
        withOrgMembership(userId, domain, async ({ org }) => {
            ...
            const body = JSON.stringify({
                q: query,
                // @see: https://github.com/your-sourcebot-org/zoekt/blob/main/api.go#L892
                opts: {
                    ChunkMatches: true,
            ...
            const parser = zoektSearchResponseSchema.transform(async ({ Result }) => {
                ...
                // @see: https://github.com/your-sourcebot-org/zoekt/pull/6
